export default function Steps() {
  const steps = [
    {
      title: "Video Ingestion & Processing",
      description:
    ...
    },
    {
      title: "Ready!",
      description: "",
      isLast: true, // Indicates the last step
    },
  ];

  return (
    <div className=" max-w-xl mt-4 mx-auto dark:bg-gray-800">
      <h2 className="mx-auto max-w-3xl justify-center flex mb-4 font-display text-3xl font-medium tracking-tight text-slate-900 sm:text-3xl">
        How does
        <span className="inline-block">
          <span className="relative whitespace-nowrap text-blue-600">
            ...
            <span className="relative">KoroKoro</span>
          </span>
        </span>
        Work?
      </h2>
      ...
      {steps.map((step, index) => (
        <div key={index} className="flex">
            ...
            <div>
              ...
              >
                <svg
                  ...
                  className={`h-6 w-6 ${
                    step.isLast ? "text-white" : "text-blue-800"
                  } dark:text-slate-200`}
                >
                  {step.isLast ? (
          ...
          <div className="pt-1 pb-8">
            <p className="mb-2 text-xl text-gray-900 dark:text-slate-300">
              {step.title}
            </p>
            {step.description && (
      ...
      <div className="flex justify-center mb-8">
        <a
          className="group inline-flex items-center justify-center rounded-full py-2 px-4 text-sm font-semibold focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 text-slate-900 bg-white hover:text-slate-700 hover:bg-slate-100 active:text-slate-800 active:bg-slate-300 focus-visible:outline-slate-900 animate-fade-in-left border-2"
          href="https://github.com/Daheer/KoroKoro/README.md"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
          ...
          <span className="ml-2">See Full Technical Documentation</span>
        </a>
      </div>
    </div>
  );
